...
- TODO: Add build-config consumption doc snippet to README and publish recommended release keystore handling.

## Build and release
- DONE: Update app icons and branding assets.
- DONE: Confirm min/target SDK and foreground service type.
...
- TODO: Decide on dependency upgrade cadence for CameraX/Material/Room/WorkManager and keep lint warnings at zero.
