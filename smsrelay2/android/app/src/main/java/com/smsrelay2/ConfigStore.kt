...
object ConfigStore {
    private const val PREFS_NAME = "smsgate_secure_prefs"
    ...
    private fun prefs(context: Context): SharedPreferences {
        return try {
            ...
            context.getSharedPreferences("smsgate_fallback_prefs", Context.MODE_PRIVATE)
        }
    }
    ...
    fun getConfig(context: Context): AppConfig {
        ...
        return AppConfig(
            serverUrl = prefs.getString(KEY_SERVER_URL, "http://#SERVER:#PORT") ?: "",
    ...
    fun defaultString(key: String): String {
        return when (key) {
            KEY_SERVER_URL -> "http://#SERVER:#PORT"
